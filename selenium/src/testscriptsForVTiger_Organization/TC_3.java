...
public class TC_3 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//To create a organization with mandatory fields
				...
				//To select an option from industry dropdwon
				WebElement Dropdowna = driver.findElement(By.name("industry"));
				Dropdowna.click();
				Select s=new Select(Dropdowna);
				s.selectByIndex(1);
				WebElement option1 = s.getFirstSelectedOption();
				System.out.println(option1.getText());
				String optionToBeSelectedIs = "Apparel";
				if(option1.equals(optionToBeSelectedIs)) {
					System.out.println("selected option is valid");
				}else {
